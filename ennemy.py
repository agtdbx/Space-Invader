...
class Ennemy():
    ...
    def __init__(self, x = 100, y = 100, vitesse = 10, typ = 1):
        ...
        if self._typ == 1: # Selon le type d'ennemy, on change la taille, le nombre de point, le nombre de vie
            ...
            self._life = 1
            self._score = 10
            self._sprites = [pg.image.load("images/Ennemy1_1.png").convert_alpha(), pg.image.load("images/Ennemy1_2.png").convert_alpha()]
            ...
            self._life = 3
            self._score = 30
            self._sprites = [pg.image.load("images/Ennemy2_1.png").convert_alpha(), pg.image.load("images/Ennemy2_2.png").convert_alpha()]
            ...
            self._last = 0
            self._score = 20
            self._sprites = [pg.image.load("images/Ennemy3_1.png").convert_alpha(), pg.image.load("images/Ennemy3_2.png").convert_alpha()]
            ...
            self._last = 0
            self._score = 150
            self._sprites = [pg.image.load("images/Ennemy4_1.png").convert_alpha(), pg.image.load("images/Ennemy4_2.png").convert_alpha()]
            ...
            self._life = 5
            self._score = 100
            self._sprites = [pg.image.load("images/Ennemy5_1.png").convert_alpha(), pg.image.load("images/Ennemy5_2.png").convert_alpha()]
    ...
    def draw(self, fen):
        ...
        """
        fen.blit(self._sprites[self._sprite], (self._x, self._y), ((self._life-1)*self._width, 0, self._width, self._height))
    ...
    def anime(self):
        """
        Méthode gérant l'animation des ennemies
        """
        if time.time() - self._last_sprite > 0.5:
            self._last_sprite = time.time()
            self._sprite += 1
            if self._sprite > 1:
                self._sprite = 0
    ...
    def get_center(self):
        """
        Méthode permetant de récupérer le centre de l'ennemy
        """
